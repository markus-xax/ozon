...
abstract class AbstractController implements ServiceSubscriberInterface
{
    ...
    public function serializeObjectToJson($object)
    {
        ...
        $normalizers = [new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($classMetadataFactory)];
        $serializer = new \Symfony\Component\Serializer\Serializer($normalizers, $encoders);
        return $serializer->serialize($object, 'json', ['json_encode_options' => JsonResponse::DEFAULT_ENCODING_OPTIONS,]);
    }
    /**
